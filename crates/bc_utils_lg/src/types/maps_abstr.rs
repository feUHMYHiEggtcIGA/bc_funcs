...
pub type MAP_BF_VEC<'a, T> = FxHashMap<&'static str, BF_VEC<'a, T>>;
pub type MAP_MAP_BF_VEC<'a, T> = FxHashMap<&'static str, MAP_BF_VEC<'a, T>>;
...
pub type MAP_MAP_RGS<T> = FxHashMap<&'static str, MAP_ARGS<T>>;
pub type MAP_MAP_MAP_ARGS<T> = FxHashMap<&'static str, MAP_MAP_RGS<T>>;
