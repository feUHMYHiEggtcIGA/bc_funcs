...
pub type MAP_ARGS<'a, T> = FxHashMap<&'static str, ARGS<'a, T>>;
pub type MAP1_ARGS<'a, T> = FxHashMap<&'static str, MAP_ARGS<'a, T>>;
pub type MAP2_ARGS<'a, T> = FxHashMap<&'static str, MAP1_ARGS<'a, T>>;
